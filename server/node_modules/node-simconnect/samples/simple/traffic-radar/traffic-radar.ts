import {ConnectionEvent, Protocol, SimConnectApp, SimConnectDataType, SimObjectType} from '../../../dist';
import { SimulationVariablesHelper } from '../../../dist/src/apiHelper/SimulationVariablesHelper';
...
async function onConnectedHandler({ simulatorInfo, apiHelpers }: ConnectionEvent) {
    ...
    apiHelpers.simulationVariables.observeObjects({
        type: SimObjectType.AIRCRAFT,
        radiusMeters: 10_000,
        simulationVariables: {
